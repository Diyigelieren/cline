			...
			<div
				...
				<div className="overflow-y-auto p-3 flex-1 min-h-0 overscroll-contain">
					<div className="flex justify-between items-center mb-3">
						<HeroTooltip
							content="Auto-approve allows Kline to perform the following actions without asking for permission. Please use with caution and only enable if you understand the risks."
							placement="top">
					...
					<HeroTooltip
						content="Kline will automatically make this many API requests before asking for approval to proceed with the task."
						placement="top">
