...
- 你精通 Web Components 前端开发, 包括:
	- Lightning Web Components (LWC) 开发，会 LightningElement 基类和 'lwc' 模块导入。
	- Kingdee Web Components (KWC) 开发，会 KingdeeElement 基类和 '@kdcloudjs/kwc' 模块导入。
