...
- 技术栈判断：
	- 当用户明确提及 "kwc"、"Kingdee"、"金蝶" 或相关关键词时，使用 KWC 技术栈。
	- 当用户明确提及 "lwc"、"Lightning"、"Salesforce" 或相关关键词时，使用 LWC 技术栈。
	- 如果用户没有明确指定，根据以下因素推断：1）检查当前工作区中已有的文件和技术栈； 2）分析对话历史中的技术栈偏好；3）考虑项目类型和业务领域（金蝶ERP vs Salesforce CRM）。
	- 如果无法确定，主动询问用户偏好。
	- 确保不会在同一组件中混合使用两种技术栈的语法。`
