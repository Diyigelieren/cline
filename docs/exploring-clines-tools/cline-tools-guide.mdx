---
title: "Kline Tools Reference Guide"
---

## What Can Kline Do?

Kline is your AI assistant that can:
...
3. **Review Changes**
    - Kline will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Kline repository](https://github.com/cline/cline/blob/main/src/core/Cline.ts).

Kline has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Kline can then access
    - Example: Create a weather API tool that Kline can use to fetch forecasts
