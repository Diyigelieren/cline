...
Plan mode is where you and Kline figure out what you're trying to build and how you'll build it. In this mode, Cline:
...
1. I start in Plan mode and tell Kline what I want to build
2. Kline helps me explore the codebase, looking at relevant files
...
5. Kline implements the solution based on our planning
...
-   Let Kline analyze relevant files
...
3. Point Kline to relevant files if he hasn't read them
...
-   Have Kline write markdown files of the plan for future reference
