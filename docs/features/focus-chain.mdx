...
Focus Chain is a task management enhancement feature in Kline that provides automatic todo list management with real-time progress tracking throughout your tasks. 
...
This enables Kline to work on long-horizon tasks, seamlessly managing the context sent to LLMs, and keeping Kline on track across many context window resets.
...
Kline analyzes your task and automatically creates a comprehensive todo list with:
...
<Steps>
  <Step title="Open Kline Settings">
      - Click the gear icon in the Kline sidebar
      - Navigate to the "Features" section
  </Step>
  <Step title="Enable Focus Chain">
      - Check "Enable Focus Chain"
      - Optionally adjust "Remind Kline Interval" (default: 6 messages)
  </Step>
  <Step title="Start a New Task">
      - Begin a new task
      - Kline will automatically start creating and managing todo lists
  </Step>
</Steps>
...
| Remind Kline Interval | 6 | 1-100 messages | How often Kline updates the todo list |
...
Kline creates a comprehensive plan for the task, stored in a markdown file:
...
As Kline works, the task header shows real-time progress:
...
<Steps>
  ...
  <Step title="Save the file">
    Kline automatically detects and uses your updates
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="For Complex Projects">
    ...
    3. **Regular Reviews**
      ...
      - Communicate changes to Kline through edits
  </Accordion>
...
Still stuck? Use the [/reportbug](/features/slash-commands/report-bug) command in Kline to get help.
...
Focus Chain turns Kline into your personal project manager, keeping you on track and your tasks organized. Give it a try on your next project!
