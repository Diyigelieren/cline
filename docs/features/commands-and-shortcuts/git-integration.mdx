...
3. Kline analyzes your changes and generates a descriptive commit message
...
1. Kline retrieves the current Git diff using `getWorkingState()`
...
This process uses your current Kline API configuration, so the quality of the generated messages matches your chosen AI model.
