...
Cline's keyboard shortcuts let you access AI assistance without taking your hands off the keyboard. Speed up your workflow by using hotkeys for common Kline actions.

## Default Keyboard Shortcuts

Kline comes with the following built-in keyboard shortcuts to streamline your workflow:

| Action                  | Windows/Linux | macOS   | Condition                    | Description                               |
| ----------------------- | ------------- | ------- | ---------------------------- | ----------------------------------------- |
| Add to Kline            | `Ctrl+'`      | `Cmd+'` | When text is selected        | Adds selected code to Kline chat          |
| Focus Chat Input        | `Ctrl+'`      | `Cmd+'` | When no text is selected     | Focuses the Kline chat input field        |
...
While Kline has only a few default keyboard shortcuts, you can assign your own shortcuts to any of these commands:

| Command ID                                                                               | Description                                   |
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`cline.openInNewTab`](/features/commands-and-shortcuts/overview)                        | Opens Kline in a new editor tab               |
| [`cline.addToChat`](/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Kline chat              |
| [`cline.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Kline                 |
| `cline.focusChatInput`                                                                   | Focuses the Kline chat input field            |
...
| `kd-cline.SidebarProvider.focus`                                                       | Opens and focuses the Kline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Kline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `kd-cline.SidebarProvider.focus`        | Opens the Kline sidebar panel |
| New Task              | `Alt+N`                        | `cline.plusButtonClicked`                 | Starts a new Kline task       |
| Add Terminal to Kline | `Alt+T`                        | `cline.addTerminalOutputToChat`           | Adds terminal output to Kline |
| Clear Current Task    | `Alt+C`                        | (Requires custom keybinding to UI action) | Clears the current task       |

## Keyboard-Only Workflow

With the right shortcuts, you can use Kline without ever touching the mouse:

1. Select code with keyboard navigation (`Shift+Arrow` keys)
2. Send to Kline with `Ctrl+'` / `Cmd+'`
...
-   Combine with VSCode's split editor shortcuts to view code and Kline side by side
...
Keyboard shortcuts may seem like a small optimization, but they can significantly speed up your workflow when using Kline regularly. By keeping your hands on the keyboard, you maintain your coding flow while still getting AI assistance exactly when you need it.

## How to Find All Available Commands

To see all Kline commands that can be assigned shortcuts:
