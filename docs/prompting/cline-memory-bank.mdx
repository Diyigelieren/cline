---
title: "Kline Memory Bank"
---

## The Complete Guide to Kline Memory Bank

### Quick Setup Guide

To get started with Kline Memory Bank:
...
4. **Initialize** - Ask Kline to "initialize memory bank"

[See detailed setup instructions](#getting-started-with-memory-bank)

### Kline Memory Bank Custom Instructions \[COPY THIS]
...
### What is the Kline Memory Bank?

The Memory Bank is a structured documentation system that allows Kline to maintain context across sessions. It transforms Kline from a stateless assistant into a persistent development partner that can effectively "remember" your project details over time.
...
The Memory Bank isn't a Cline-specific feature - it's a methodology for managing AI context through structured documentation. When you instruct Kline to "follow custom instructions," it reads the Memory Bank files to rebuild its understanding of your project.
...
Memory Bank files are simply markdown files you create in your project. They're not hidden or special files - just regular documentation stored in your repository that both you and Kline can access.
...
3. Ask Kline to "initialize memory bank"
...
-   Kline will help fill in gaps and ask questions
...
-   **"follow your custom instructions"** - This tells Kline to read the Memory Bank files and continue where you left off (use this at the start of tasks)
...
-   **Custom Instructions**: Applied globally to all Kline conversations. Good for consistent behavior across all projects.
...
1. Ask Kline to **"update memory bank"** to document the current state
2. Start a new conversation/task
3. Ask Kline to **"follow your custom instructions"** in the new conversation
...
-   Let Kline help create the initial structure
...
1. Open VSCode
2. Click the Kline extension settings ⚙️
...
3. Save the file
4. Kline will automatically apply these rules when working in this project
...
_For more information, reference our_ [_blog_](https://cline.bot/blog/memory-bank-how-to-make-cline-an-ai-agent-that-never-forgets) _on Kline Memory Bank_

---

### Contributing to Kline Memory Bank

This guide is maintained by the Kline and the Kline Discord Community:
