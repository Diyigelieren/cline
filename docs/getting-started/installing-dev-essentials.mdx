...
description: >-
    ...
    on your computer. Kline can help you install everything you need in a safe,
    guided way.
---
...
> **Pro Tip:** Kline will show you each command before running it. You stay in control the entire time!

### What Will Happen

Kline will guide you through the following steps:
...
> **Tip:** The installation process is interactive — Kline will guide you step by step!

-   All commands are shown to you for approval before they run.
-   If you run into any issues, Kline will help troubleshoot them.
