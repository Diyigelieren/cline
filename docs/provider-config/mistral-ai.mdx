...
Kline supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
Kline supports the following Mistral models:
...
1.  **Select "Mistral" as the API Provider in Kline Settings.**
