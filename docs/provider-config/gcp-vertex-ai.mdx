---
title: "GCP Vertex AI"
description: "Configure GCP Vertex AI with Kline to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams."
---
...
<Frame>
	<img
		...
		alt="Kline extension in VS Code"
	/>
</Frame>
...
-   **Open Kline Settings:**\
    Click the settings ⚙️ icon within the Kline extension
-   **Set API Provider:**\
...
3. **Restart VS Code:**\
   Ensure VS Code is restarted so that the Kline extension picks up the new credentials
...
By following these steps, your enterprise team can securely integrate GCP Vertex AI with the Kline VS Code extension to harness the power of **Claude 3.5 Sonnet v2**:
...
_This guide will be updated as GCP Vertex AI and Kline evolve. Always refer to the latest documentation for current practices._
