...
description: "Set up AWS Bedrock with Kline using IAM Access Key and Secret Key credentials. Best for enterprise environments with established IAM policies."
---
...
By following these steps, your enterprise team can securely integrate AWS Bedrock with the Kline VS Code extension to accelerate development:
...
3. **Configure Kline in VS Code:** Install and set up Kline with your AWS credentials and choose an appropriate model.
