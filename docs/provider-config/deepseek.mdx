...
Kline supports accessing models through the DeepSeek API, including `deepseek-chat` and `deepseek-reasoner`.
...
Kline supports the following DeepSeek models:
...
1.  **Open Kline Settings:** Click the ⚙️ icon in the Kline panel.
