---
title: "LiteLLM & Kline (using Codestral)"
description: "Learn how to set up and run LiteLLM with Kline using the Codestral model. This guide covers Docker setup, configuration, and integration with Cline."
---
...
-   [Kline Discord Community](https://discord.gg/cline)
