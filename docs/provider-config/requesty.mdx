---
title: "Requesty"
description: "Learn how to use Requesty with Kline to access and optimize over 150 large language models."
---

Kline supports accessing models through the [Requesty](https://www.requesty.ai/) AI platform. Requesty provides an easy and optimized API for interacting with 150+ large language models (LLMs).
...
Requesty provides access to a wide range of models. Kline will automatically fetch the latest list of available models. You can see the full list of available models on the [Model List](https://app.requesty.ai/router/list) page.

### Configuration in Cline

1.  **Open Kline Settings:** Click the settings icon (⚙️) in the Kline panel.
