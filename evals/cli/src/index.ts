...
// Set up CLI metadata
program.name("cline-eval").description("CLI tool for orchestrating Kline evaluations across multiple benchmarks").version("0.1.0")
...
program
	...
	.option("-k, --api-key <apiKey>", "Kline API key to use for evaluations")
	.action(async (options) => {
		try {
