...
`,
	...
	const settings = {
		...
		"workbench.view.extension.kd-saoudrizwan.kd-cline-ActivityBar.visible": true,
	...
	const keybindings = [
		{
			key: "alt+c",
			command: "workbench.view.extension.kd-saoudrizwan.kd-cline-ActivityBar",
			when: "viewContainer.workbench.view.extension.kd-saoudrizwan.kd-cline-ActivityBar.enabled",
		},
		{
			key: "alt+shift+c",
	...
	const args = [
		...
		"--command",
		"workbench.view.extension.kd-saoudrizwan.kd-cline-ActivityBar",
